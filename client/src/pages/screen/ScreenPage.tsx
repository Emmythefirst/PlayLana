...
export default function ScreenPage() {
  ...
  return (
    ...
    >
      ...
      {/* ── Game: Unity iframe fills the screen ── */}
      {gameStarted && (
        <>
          <iframe
            ref={iframeRef}
          ...
          {/* React overlay on top of Unity */}
          <GameOverlay state={hostState} />
          ...
          {round === "over" && winner !== null && (
            <WinnerAnnouncement
              ...
              scores={scores}
              onDismiss={() => {
                // Tell Unity to reset — send postMessage
      ...
      {/* Connection status pill — dev helper, remove for prod */}
      {!connected && (
        <div
          style={{
            position: "fixed",
